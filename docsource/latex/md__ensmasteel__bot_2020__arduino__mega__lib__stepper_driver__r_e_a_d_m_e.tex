\href{https://www.ardu-badge.com/StepperDriver}{\texttt{ }} \href{https://travis-ci.com/laurb9/StepperDriver}{\texttt{ }}\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md4}{}\doxysection{Stepper\+Driver}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md4}
...
\end{DoxyItemize}\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md5}{}\doxysection{Microstepping}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md5}
The library can set microstepping and generate the signals for each of the support driver boards.

High RPM plus high microstep combinations may not work correctly on slower MCUs, there is a maximum speed achieveable for each board, especially with acceleration on multiple motors at the same time.\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md6}{}\doxysection{Motors}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md6}
...
\end{DoxyItemize}\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md7}{}\doxysection{Connections}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md7}
Minimal configuration from \href{https://www.pololu.com/product/2134}{\texttt{ Pololu DRV8834 page}}\+:

\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md8}{}\doxysection{Wiring}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md9}{}\doxysection{Set Max Current}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md9}
...
For latest info, see the Pololu board information pages.\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md10}{}\doxysection{Code}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md10}
...
\end{DoxyCode}
\hypertarget{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md11}{}\doxysection{Hardware}\label{md__ensmasteel__bot_2020__arduino__mega__lib__stepper_driver__r_e_a_d_m_e_autotoc_md11}
