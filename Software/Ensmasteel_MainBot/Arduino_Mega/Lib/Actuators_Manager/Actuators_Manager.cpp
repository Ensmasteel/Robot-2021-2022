...
Manager::Manager(Stream *serController, HardwareSerial *serDebug)
{
    ...
    brasGauche.Init(brasGauche_servoPWM, MessageID::BrasG_M);
    brasDroit.Init(brasDroit_servoPWM, MessageID::BrasD_M);
    ...
    pinceArr.Init(pinceArr_servoPWM, pinceArr_Dir, pinceArr_Step, pinces_Sleep, pincesArr_M0, pincesArr_M1, MessageID::PinceArr_M);
