...
void MoveProfiles::setup() {
    ...
    get(accurate,true)->set(1000,4,150,1,0.001,0.0005,0.01,0.5,0.2);
    get(accurate,false)->set(350, 300, 100,1, 0.008, 0.001, 0.05,1.5,1.0);
    
    get(standard,true)->set(1000, 150, 95,1, 0.10, 0.05, 0.20,1.0,0.7); 
    get(standard,false)->set(350, 100, 100,1, 0.05, 0.01, 0.05,3.2,2.5);

    get(fast,true)->set(700, 200, 600,1, 0.15, 0.05, 0.1,2.5,1.2);
    get(fast,false)->set(350, 100, 100,1, 0.05, 0.01, 0.05,10.0,5.0);
